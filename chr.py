...
# class Test:
#     def generate_base64_sequence(self, length):
#         base64_chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/"
#         base64_list = []
#         for i in range(length):
#             s = ""
#             n = i + 1  # Start from 1 to avoid empty string
#             while n > 0:
#                 n -= 1
#                 s = base64_chars[n % 64] + s
#                 n = n // 64
#             base64_list.append(s)
#         return base64_list
# testvalue = Test()
# for i in range(26**10):
#     print(testvalue.generate_base64_sequence(i))
# import math
# import random
# prime = []
# def is_prime(n):
...
# primenumber = 1000000
# addition = 0
# for i in range(addition,primenumber+addition):
#     if is_prime(i):
#         prime.append(i)
#         print(i, end='|')
# # for i in range(len(prime)):
# #     print(prime[i], end='|')
# print(prime[random.randint(0,len(prime))], end='|\|')
# print("Primes: ", len(prime))
